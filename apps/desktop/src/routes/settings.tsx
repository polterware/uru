...
function Settings() {
    ...
    async function handleSaveProfile() {
        try {
            ...
            await SettingsStore.set("organization_name", organizationName)
            await SettingsStore.set("owner_email", ownerEmail)
    ...
    async function handleSaveNetwork() {
        try {
            ...
            await SettingsStore.set("server_port", serverPort)
            await SettingsStore.set("server_protocol", serverProtocol)
