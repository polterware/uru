use crate::review::models::review_model::Review;
use crate::product::repositories::product_metrics_repository::ProductMetricsRepository;
use crate::review::repositories::reviews_repository::ReviewsRepository;
use sqlx::SqlitePool;
