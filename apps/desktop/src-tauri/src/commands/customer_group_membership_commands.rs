use crate::dtos::customer_group_membership_dto::AssignCustomerGroupsDTO;
use crate::models::customer_model::CustomerGroupMembership;
use crate::services::customer_group_membership_service::CustomerGroupMembershipService;
use sqlx::SqlitePool;
use tauri::State;
