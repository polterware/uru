use crate::dtos::customer_address_dto::{CreateCustomerAddressDTO, UpdateCustomerAddressDTO};
use crate::models::customer_model::CustomerAddress;
use crate::services::customer_address_service::CustomerAddressService;
use sqlx::SqlitePool;
use tauri::State;
