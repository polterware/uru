use crate::dtos::customer_group_dto::{CreateCustomerGroupDTO, UpdateCustomerGroupDTO};
use crate::models::customer_group_model::CustomerGroup;
use crate::repositories::customer_group_memberships_repository::CustomerGroupMembershipsRepository;
use crate::repositories::customer_groups_repository::CustomerGroupsRepository;
use sqlx::SqlitePool;
