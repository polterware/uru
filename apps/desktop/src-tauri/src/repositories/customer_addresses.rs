use sqlx::SqlitePool;
use crate::models::customer_address::CustomerAddress;
...
impl CustomerAddressesRepository {
    ...
    pub async fn create(&self, address: CustomerAddress) -> Result<CustomerAddress, sqlx::Error> {
        let sql = r#"
    ...
    pub async fn update(&self, address: CustomerAddress) -> Result<CustomerAddress, sqlx::Error> {
        let sql = r#"
    ...
    pub async fn get_by_id(&self, id: &str) -> Result<Option<CustomerAddress>, sqlx::Error> {
    ...
    pub async fn list_by_customer_id(&self, customer_id: &str) -> Result<Vec<CustomerAddress>, sqlx::Error> {
