use crate::customer::dtos::customer_dto::{CreateCustomerDTO, UpdateCustomerDTO};
use crate::customer::models::customer_model::Customer;
use crate::customer::repositories::customer_repository::CustomerRepository;
use crate::customer_address::repositories::customer_addresses_repository::CustomerAddressesRepository;
use crate::customer_group_membership::repositories::customer_group_memberships_repository::CustomerGroupMembershipsRepository;
use sqlx::SqlitePool;
