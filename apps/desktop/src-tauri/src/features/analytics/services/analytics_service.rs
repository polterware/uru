...
impl AnalyticsService {
    ...
    pub async fn get_revenue_by_category(&self) -> Result<Vec<RevenueByCategoryDto>, String> {
        let rows = self
            .repo
    ...
    pub async fn get_category_distribution(&self) -> Result<Vec<CategoryDistributionDto>, String> {
        let rows = self
            .repo
