use crate::inquiry::dtos::inquiry_dto::CreateInquiryDTO;
use crate::inquiry::models::inquiry_model::{Inquiry, InquiryMessage};
use crate::inquiry::repositories::inquiries_repository::InquiriesRepository;
use crate::inquiry::repositories::inquiry_messages_repository::InquiryMessagesRepository;
use chrono::Utc;
use sqlx::SqlitePool;
use uuid::Uuid;
