use crate::user::dtos::user_dto::{CreateUserDTO, UpdateUserDTO};
use crate::user::models::user_model::User;
use crate::user_identity::repositories::user_identities_repository::UserIdentitiesRepository;
use crate::user::repositories::user_repository::UserRepository;
use crate::user_role::repositories::user_roles_repository::UserRolesRepository;
use crate::user_session::repositories::user_sessions_repository::UserSessionsRepository;
use sqlx::SqlitePool;
