use crate::shop::dtos::shop_dto::{CreateShopDTO, UpdateShopDTO};
use crate::shop::models::shop_model::Shop;
use crate::shop::repositories::shop_repository::ShopsRepository;
use sqlx::SqlitePool;
