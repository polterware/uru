use crate::checkout::models::checkout_model::Checkout;
use crate::order::models::order_model::Order;
use crate::checkout::repositories::checkouts_repository::CheckoutsRepository;
use crate::customer::repositories::customer_repository::CustomerRepository;
use crate::order::repositories::orders_repository::OrdersRepository;
use chrono::Utc;
use sqlx::SqlitePool;
use uuid::Uuid;
