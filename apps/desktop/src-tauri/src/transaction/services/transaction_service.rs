use crate::transaction::dtos::transaction_dto::CreateTransactionDTO;
use crate::transaction::models::transaction_model::{InventoryMovement, Transaction};
use crate::customer::repositories::customer_repository::CustomerRepository;
use crate::inventory::repositories::inventory_levels_repository::InventoryLevelsRepository;
use crate::inventory::repositories::inventory_movements_repository::InventoryMovementsRepository;
use crate::transaction::repositories::transaction_items_repository::TransactionItemsRepository;
use crate::transaction::repositories::transactions_repository::TransactionsRepository;
use chrono::Utc;
use sqlx::SqlitePool;
use uuid::Uuid;
