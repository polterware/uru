use crate::shipment::dtos::shipment_dto::CreateShipmentDTO;
use crate::shipment::models::shipment_model::{Shipment, ShipmentEvent, ShipmentItem};
use crate::shipment::repositories::shipment_events_repository::ShipmentEventsRepository;
use crate::shipment::repositories::shipment_items_repository::ShipmentItemsRepository;
use crate::shipment::repositories::shipments_repository::ShipmentsRepository;
use chrono::Utc;
use sqlx::SqlitePool;
use uuid::Uuid;
